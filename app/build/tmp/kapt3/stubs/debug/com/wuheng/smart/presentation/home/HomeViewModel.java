...
public final class HomeViewModel extends com.wuheng.smart.presentation.base.BaseViewModel {
    ...
    private final long AUTO_REFRESH_INTERVAL = 30000L;
     ...
     * 静默刷新设备列表（不显示加载状态）
     */
    private final void refreshDeviceListSilently(java.lang.String houseId) {
    }
    
    /**
     * 静默刷新系统状态（不显示加载状态）
     */
    private final void refreshSystemStatusSilently(java.lang.String houseId) {
    }
